...
public:
    ...
    /**
     * Initializes a stereo sine wave of 441 Hz.
     *
    ...
    /**
     * Initializes a sine wave of 441 Hz.
     *
    ...
    /**
     * Returns a newly allocated sine wave of 441 Hz.
     *
     * When included in an audio graph, the node will support 2 channels at a
     * sampling rate of 44100 Hz.
     *
     * @return a newly allocated sine wave of 441 Hz.
     */
...
const float AudioWaveform::DEFAULT_FREQUENCY = 441.0f;
