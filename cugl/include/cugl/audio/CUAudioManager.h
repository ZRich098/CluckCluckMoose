 ...
 * audio graph is necessary.  Most developers can use {@link AudioChannel}
...
#pragma mark Output Devices
    /**
     * Returns the default output device with 2 channels at 44100 Hz.
     *
     ...
     *
     * @return the default output device with 2 channels at 44100 Hz.
     */
    ...
    /**
     * Returns the given output device with 2 channels at 44100 Hz.
     *
     * An output device is initialized with both active and paused as false.
     * That means it will begin playback as soon as the audio manager is
     * activated.
     ...
     *
     * @return the given output device with 2 channels at 44100 Hz.
     */
...
#pragma mark Input Devices
    /**
     * Returns the default input device with 2 channels at 44100 Hz.
     *
     ...
     * This method may fail if the default device is in use.
     *
     * @return the default input device with 2 channels at 44100 Hz.
     */
    ...
    /**
     * Returns the given input device with 2 channels at 44100 Hz.
     *
     * The input delay will be equal to the value {@link getWriteSize()}.
     * This means that playback is only available after two calls to
     * {@link AudioInput#record()}.  This is the minimal value for smooth
     ...
     * @param device    The name of the output device
     *
     * @return the given input device with 2 channels at 44100 Hz.
     */
     ...
     * @return whether the device was successfully closed.
     */
    bool closeInput(const std::shared_ptr<audio::AudioInput>& engine);
