...
//            activatePause();
    ...
    pausebuttons.push_back(pauseSettings); // 2
...
void SceneBuilder1::deactivatePause() {
	for (int i = 0; i < 4; i++) {
        CULog("deactivating pausebutton[%d]", i);
