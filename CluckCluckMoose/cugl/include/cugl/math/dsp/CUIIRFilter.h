 ...
 * more efficient.
 *
 * This class supports vector optimizations for SSE and Neon 64 via the
 * {@link setAlgorithm} attribute. In timed simulations, these optimizations
 * provide at least a 3-4x performance increase (and for 4 or 8 channel audio,
 * much higher). These optimizations make use of the matrix precomputation
 * outlined in "Implementation of Recursive Digital Filters into Vector SIMD
 * DSP Architectures"
 *
 *   https://pdfs.semanticscholar.org/d150/a3f75dc033916f14029cd9101a8ea1d050bb.pdf
 *
